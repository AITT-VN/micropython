...
BIRTHDAY = [
    ...
    'f:4', 'c:1.5', 'c:0.5', 'c5:2', 'a:2', 'f:2', 'e:2', 'd:2', 'a#:1.5', 'a#:0.5', 'a:2',
    'f:2', 'g:2', 'f:4'
]

WEDDING = [
    'c4:2', 'f:1.5', 'f:0.5', 'f:4', 'c:2', 'g:1.5', 'e:0.5', 'f:4', 'c:2', 'f:1.5',
    'a:0.5', 'c5:2', 'a4:1.5', 'f:0.5', 'f:2', 'e:1.5', 'f:0.5', 'g:4'
]

PYTHON = [
    'd5:0.5', 'b4:0.5', 'r:0.5', 'b:0.5', 'b:0.5', 'a#:0.5', 'b:0.5', 'g5:0.5', 'r:0.5', 'd:0.5', 'd:0.5', 'r:0.5', 'b4:0.5',
    'c5:0.5', 'r:0.5', 'c:0.5', 'c:0.5', 'r:0.5', 'd:0.5', 'e:2.5', 'c:0.5', 'a4:0.5', 'r:0.5', 'a:0.5', 'a:0.5', 'g#:0.5',
    'a:0.5', 'f#5:0.5', 'r:0.5', 'e:0.5', 'e:0.5', 'r:0.5', 'c:0.5', 'b4:0.5', 'r:0.5', 'b:0.5', 'b:0.5', 'r:0.5', 'c5:0.5', 'd:2.5',
    'd:0.5', 'b4:0.5', 'r:0.5', 'b:0.5', 'b:0.5', 'a#:0.5', 'b:0.5', 'b5:0.5', 'r:0.5', 'g:0.5', 'g:0.5', 'r:0.5', 'd:0.5', 'c#:0.5',
    'r:0.5', 'a:0.5', 'a:0.5', 'r:0.5', 'a:0.5', 'a:2.5', 'g:0.5', 'f#:1', 'a:0.5', 'a:0.5', 'g#:0.5', 'a:0.5',
    'e:1', 'a:0.5', 'a:0.5', 'g#:0.5', 'a:0.5', 'd:0.5', 'r:0.5', 'c#:0.5', 'd:0.5', 'r:0.5', 'c#:0.5', 'd:1', 'r:1.5'
]
...
class MIDI():
    ...
    def set_default(self, tone):
        ...
        if pos != -1:
            ...
            tone = tone[:pos]
    def _play(self, tune, loop=False, pin=25, duration=None):
        if not self.stop():
            return      
        pwm = PWM(Pin(pin))
        try:
