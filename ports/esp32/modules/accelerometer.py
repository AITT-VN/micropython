...
class Direction(Accelerometer):
    ...
    def is_gesture(self, gesture="shake"):
        if gesture == 'shake':
            return self.sensor.shake(14)
        elif gesture == 'tapped':
            return self.sensor.tapped
        elif gesture == 'tilt_up':
            return self.get_y() < -20
        elif gesture == 'tilt_down':
            return self.get_y() > 20
        elif gesture == 'tilt_left':
            return self.get_x() < -20
        elif gesture == 'tilt_right':
            return self.get_x() > 20
        elif gesture == 'face_up':
            return self.get_z() < 0
        elif gesture == 'face_down':
            return self.get_z() > 0
        else:
            print(gesture + " not supported.")
            return False
